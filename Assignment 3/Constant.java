...
public class Constant {
    final String String_Input = "Enter a String: ";
    final String Integer_Input = "Enter an Integer: ";
    final String Options = "Enter the option you want to perform: ";
    final String CombinationGenerator = "1: Valid Parentheses Combination Generator";
    final String DigitSum = "2: Digit Sum Loop";
    final String NumberSummer = "3: Consecutive Number Summer";
    final String CaesarCipher = "4: Caesar Cipher with Shift Variability";
    final String Encoding = "5: Encoding Challenge with ASCII Conversion";
